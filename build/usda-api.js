 ...
 */
const USDA_API_KEY = process.env.USDA_API_KEY || "DaE4Ljcov428VPj5A9930A2eZ0u4cFkMv9UdUt05";
 ...
 */
const requestQueue = []; // Timestamps of recent requests
 ...
 */
export async function makeUSDARequest(endpoint) {
    const now = Date.now();
...
export async function searchFoods(query, pageSize = 5) {
    ...
    return await makeUSDARequest(endpoint);
}
